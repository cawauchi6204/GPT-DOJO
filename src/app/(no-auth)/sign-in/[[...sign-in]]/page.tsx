      ...
      <div className="w-full max-w-md rounded-lg p-8 shadow-lg">
        <SignIn
          appearance={{
            elements: {
              formButtonPrimary:
                "bg-purple-600 hover:bg-purple-700 rounded-xl transform transition-all duration-200 hover:scale-105",
              card: "shadow-none",
              headerTitle: "hidden",
              headerSubtitle: "hidden",
              socialButtonsBlockButton:
                "border border-gray-300 hover:bg-gray-50 rounded-xl transition-all duration-200 hover:shadow-md",
              formFieldInput:
